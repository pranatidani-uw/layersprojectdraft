...
namespace {
        ...
        XrView* const views)
    {
        ...
        //new additions to write to a file 

        /*
        
        // Create and open a text file
        ofstream MyFile("C:\\Users\\prana\\source\\repos\\XR_APILAYER_NOVENDOR_fov_modifier\\filename.txt");

        // Write to the file
        MyFile << "in locateviews";
        ...
        PFN_xrVoidFunction* const function)
    {
        ...
        //am i writing to a file correctly? 

        

       
        ofstream MyFile("C:\\Users\\prana\\source\\repos\\XR_APILAYER_NOVENDOR_fov_modifier\\filename2.txt");

        // Write to the file
        MyFile << "printed out in xrGetInstanceProcAddr!";
        ...
        ofstream newFile("C:\\Users\\prana\\source\\repos\\XR_APILAYER_NOVENDOR_fov_modifier\\filename3.txt");

        // Write to the file
        newFile << "file 3 printed";
        ...
        if (config.loaded && result == XR_SUCCESS)
        {
            ...
            */
            ...
            if (apiName == "xrLocateViews") {
                //MyFile << "api name discovered for xrLocateViews";
                //printf("api name discovered for xrLocateViews");
...
extern "C" {
        ...
        XrNegotiateApiLayerRequest* const apiLayerRequest)
    {
        ...
        ofstream outfile("C:\\Users\\prana\\source\\repos\\layersproject2\\writingToFile.txt");
        outfile << "i am writing to outfile in dillmain.cpp in the layersproject2 folder";
        ...
        */
        ...
        printf("reached file portion for xrGetInstanceProcAddr");
        ofstream MyFile("C:\\Users\\prana\\source\\repos\\XR_APILAYER_NOVENDOR_fov_modifier\\filename2.txt");
